	...
	public String getServerName() {
		try {
			...
			if (mbeanServer.isRegistered(objName)) {
				String name = (String) mbeanServer.getAttribute(objName, "Name");
				String libertyVersion = (String) mbeanServer.getAttribute(objName, "LibertyVersion");
				return "Server: " + name + " (" + libertyVersion + ")";
			}
			return "";
		} catch (Throwable t) {
			//t.printStackTrace();
			//return "Error looking up server name: " + t.getLocalizedMessage();
			return "";
		}
	}
}
